...
function Contact() {
  return (
    <div
      class="px-10 mt-24 mx-auto max-w-7xl md:px-16 tails-selected-element"
    ...
    >
      <div class="max-w-3xl mx-auto mb-10 md:mb-16">
        ...
        <p class="max-w-screen-md mx-auto mt-4 text-left text-gray-500 md:text-lg md:mt-6">
          Fill out the form below and we'll do some research on our end and get
          back to you within 24-48 hours. For specific technical issues, please
          visit our{" "}
